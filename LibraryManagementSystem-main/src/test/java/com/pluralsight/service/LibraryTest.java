...
import com.pluralsight.exception.lib.MemberNotFoundException;
...
public class LibraryTest {
    ...
    void testBorrowItem() {
        ...
        assertTrue(member1.hasBorrowedItem("1234567890"));
    ...
    void testReturnItem() {
        ...
        assertFalse(member1.hasBorrowedItem("1234567890"));
    ...
    void testReturnWithNonExistentMember() {
       // assertThrows(MemberNotFoundException.class, library.returnItem("M9999", "1234567890"));
    }
    @Test
    ...
    void testMemberBorrowMultipleItems() {
        ...
        assertTrue(member1.hasBorrowedItem("1234567890"));
        assertTrue(member1.hasBorrowedItem("MOV001"));
        assertTrue(member1.hasBorrowedItem("MAG001"));
    }
