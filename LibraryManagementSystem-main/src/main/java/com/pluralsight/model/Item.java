...
public class Item {
    ...
    public Item(String id, String title, String creator, String genre, float lateFee) {
        this.id = id;
        this.title = title;
    ...
    public Item(String id, String title, String creator, String genre, float lateFee, boolean isAvailable) {
        this.id = id;
        this.title = title;
        this.creator = creator;
        this.genre = genre;
